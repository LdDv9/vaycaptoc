...
function onepress_scripts() {
    ...
    wp_enqueue_style( 'onepress-bootstrap', WP_HOME .'/asset/bootstrap/css/bootstrap.min.css', false, $version );
...
//    wp_enqueue_script( 'jquery-3',WP_HOME.'/asset/jq/jquery-3.3.1.min.js',array(),'3.3.1' );

//	wp_enqueue_script( 'onepress-js-plugins', get_template_directory_uri() . '/assets/js/plugins.js', array( 'jquery' ), $version, true );
//	wp_enqueue_script( 'onepress-js-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), $version, false );
    wp_enqueue_script('swal',WP_HOME.'/asset/plugin/swal/sweetalert2.all.js',array(), $version, true );
