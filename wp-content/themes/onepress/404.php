...
get_header(); ?>
	<div id="content" class="site-content">
		...
		<div class="page-header">
			<div class="container">
				<h1 class="page-title"><?php esc_html_e( 'Xin lỗi trang bạn truy cập hiện không tìm thấy.', 'vaycaptoc.com' ); ?></h1>
			</div>
		</div>
				...
				<main id="main" class="site-main" role="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							<p><?php esc_html_e( 'Hãy thử tìm kiếm với 1 số từ khóa liên quan !', 'vaycaptoc.com' ); ?></p>

							<?php get_search_form(); ?>

							<?php the_widget( 'WP_Widget_Recent_Posts' ); ?>
                        <div><img src="https://vaycaptoc.com/wp-content/uploads/2018/03/404.jpg" alt=""></div>
