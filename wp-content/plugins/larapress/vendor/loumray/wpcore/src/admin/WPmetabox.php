...
use WPLaravelBoostrap\WPCore\Forms\FieldSetInterface;
...
class WPmetabox extends WPaction
{
    ...
    public function __construct(
        ...
        if (is_null($saveableClass)) {
            $this->saveableClass = '\WPLaravelBoostrap\WPCore\WPcustomPost';
        } elseif (!in_array('WPLaravelBoostrap\WPCore\admin\WPpostSaveable', class_implements($saveableClass))) {
            throw new \InvalidArgumentException("WPmetabox saveableClass must be the name of a class that implements WPLaravelBoostrap\WPCore\WPpostSaveable interface");
        }
    }
